...
public class IcosaedroApp3_2 extends Applet
{
    ...
    public BranchGroup createSceneGraph() {
        ...
        //Create interposition interpolator
        PositionInterpolator positionInterpolator = new PositionInterpolator(alpha,objMove);
        ...
        objMove.addChild(new Icosaedro());
        objRoot.addChild(positionInterpolator);

        objRoot.compile();
        return objRoot;
    } // end of CreateSceneGraph method of IcosaedroApp
    // Create a simple scene and attach it to the virtual universe
    public IcosaedroApp3_2() {
    ...
    public static void main(String[] args) {
        Frame frame = new MainFrame(new IcosaedroApp3_2(), 1000, 600);
